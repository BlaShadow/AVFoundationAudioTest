...
class AudioPlayerView: UIView {
  ...
  private func setupViews() {
    ...
    NSLayoutConstraint.activate([
      self.playPauseButton.widthAnchor.constraint(equalTo: self.controlsContainer.widthAnchor, multiplier: 0.5, constant: -10),
    ...
    NSLayoutConstraint.activate([
      self.recordbutton.widthAnchor.constraint(equalTo: self.controlsContainer.widthAnchor, multiplier: 0.5, constant: -10),
